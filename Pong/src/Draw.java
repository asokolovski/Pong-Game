...
public class Draw extends JPanel implements KeyListener {
											...
											// pressed and then repaint paddles
	{
		...
		if (arg0.getKeyCode() == KeyEvent.VK_W && paddle1.y > 10)
			paddle1.y -= 8;
		if (arg0.getKeyCode() == KeyEvent.VK_DOWN && paddle2.y < 290)
			paddle2.y += 8;
		if (arg0.getKeyCode() == KeyEvent.VK_UP && paddle2.y > 10)
			paddle2.y -= 8;
		repaint();
	}
	...
	public void update(boolean x) {//update procedure to call collision and repaint procedures
    if(x) AIPaddle();
	...
	public void collision() {//procedure to check all possible collisions of the ball
		...
		Random rand = new Random();//creating instance of Random class caled rand
